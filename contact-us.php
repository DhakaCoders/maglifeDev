...
<head>
    ...
    <title>Contact Us - MagLife Bracelet</title>
...
<div class="white_bg_cont pb_0 pt_0" id="rest">
    <div class="container">
        <div class="box shade">
            <!-- /pricing end -->
            <!-- money back sec -->
            <div class="money_back_sec disclaimer-sec common-p white mt_20 contact_div wow fadeInUp animated">
                <div class="heading_line step_headline wow fadeInUp animated" data-wow-delay="0.3s">
                    <h1>Contact Us</h1>
                    <!--<img src="img/headline_divider.png">-->
                </div>
                <div class="col-sm-12 col-md-8 col-md-offset-2 ">
                    <p style="text-align:center;text-decoration:none;width: 102%">
                        Feel free to reach our dedicated customer support at (833) 287-4246 or support@maglifebracelet.com
                    </p>
