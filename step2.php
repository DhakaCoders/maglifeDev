                ...
                <form action="./step2.php?product_id=<?php echo $_REQUEST['product_id'] ?>" method="post"
                    ...
                    <div class="customer_info hdr-sec-wrp">
                        ...
                        <div class="shipping_add">
                            ...
                            <input class="input_form" type="text" pattern="[0-9]+"
                                   placeholder="Phone number" id="phone" name="fields_phone" minlength="5"
                                   maxlength="20" value="<?php echo $_SESSION['fields_phone']; ?>">
                            ...
                            <input type="text" pattern="[a-zA-Z0-9\s\-]+" placeholder="Zip Code" id="postal_code"
                                   onfocusout="partial();" name="shippingZip"  maxlength="15"
                        ...
                        <div class="mt-20 mb-20 billing_add" style="display: none">
                            ...
                            <input class="input_form" pattern="[a-zA-Z0-9\s\-]+" type="text" name="billing_postcode"
                                   onfocusout="partial();" id="postal_code_ship"  maxlength="15"
...
<script>
    ...
    $.ajax({
        ...
        .done(function (msg) {
            ...
            var states_1 = $("#administrative_area_level_22");
            states_1.append('<option value="">Select State</option>');
    ...
    function myFunction(item, index) {
        ...
        if(item.code == '<?php echo $_SESSION['shippingState']; ?>') {
            var elem = $('<option selected value=' + item.code + '>' + item.name + '</option>');
        }else{
            var elem = $('<option value=' + item.code + '>' + item.name + '</option>');
        }
    ...
    //Start Billing
    var cc = $("#billing_country option:selected").val();
    if(cc == ""){
        cc = 'US';
    }
    $.ajax({
        ...
        .done(function (msg) {
            ...
            var states = JSON.parse(msg);
            var states_1 = $("#administrative_area_level_22_ship");
            states_1.append('<option value="">Select State</option>');
