...
<head>
    ...
    <title>Privacy Policy MagLife Bracelet</title>
    <meta property="og:site_name" content="MagLife Bracelet">
    ...
    <style>
        .ocu-hidden.ocu-hidden.ocu-hidden, .bold_hidden.bold_hidden.bold_hidden {
                ...
                <div class="grid__item medium-up--one-third medium-up--push-one-third logo-align--center">
                    <div class="h2 site-header__logo">
                        <a href="/" class="site-header__logo-image site-header__logo-image--centered">
                            <img src="img/logo_360x.png" data-widths="[180, 360, 540, 720, 900, 1080, 1296, 1512, 1728, 2048]" data-aspectratio="2.7120352867044737"
                                 data-sizes="auto" alt="MagLife Bracelet" style="max-width: 250px">
                        </a>
                    </div>
                </div>
            </div>
