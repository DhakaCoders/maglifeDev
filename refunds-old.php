...
<head>
    ...
    <title>Refunds - MagLife Bracelet</title>
    <link href="css/bootstrap.css" rel='stylesheet' type='text/css'/>
    <link rel="stylesheet" href="css/terms.css"/>
    <link rel="stylesheet" href="css/style22.css?v=1.9" type="text/css" media="screen">
...
<header>
    <div class="container">
        <div class="row">
            <div class=" col-sm-8 logo wow fadeInLeft animated">
                <div class="logo_main"><img src="img/logo.png" alt=""></div>
            </div>
        </div>
    </div>
</header>    <!--=====container white section=====-->
<div class="white_bg_cont pb_0 pt_0">
    <div class="container">
        <div class="box shade">
            <!-- /pricing end -->
            <!-- money back sec -->
            <div class="money_back_sec disclaimer-sec common-p white no-break mt_20 wow fadeInUp animated">
                <div class="col-sm-12">
                    ...
                    <p>
				<span style="color:#005f9a;"><i class="fa fa-check"></i>
					<b>How To Initiate A Refund:</b>
				</span>
                        If by any chance, you decide that one of our products are not for you, you can easily request
                        your money back by sending an email to support@maglifebracelet.com, or contacting our Customer
                        Support Team at (833) 287-4246.
                    </p>
                </div>
            </div>
            <!-- money back sec end-->
